...
# 2: Git clone
echo "Step 2: Clone project HelloTencent from git ..."
...
# 3: Move to project source root folder
echo "Step 3: Move to project source root folder..."
cd $PROJECT_NAME
...
# 4: Add dependencies
echo "Step 4.1: get go-bindata"
go get -u github.com/jteeuwen/go-bindata/...

echo "Step 4.2: get go-bindata-assetfs"
go get github.com/elazarl/go-bindata-assetfs/...

echo "Step 4.3: get protoc-gen-go"
go get -u github.com/golang/protobuf/protoc-gen-go

echo "Step 4.4: get protoc-gen-grpc-gateway"
go get -u github.com/grpc-ecosystem/grpc-gateway/protoc-gen-grpc-gateway

echo "Step 4.5: get protoc-gen-swagger"
go get -u github.com/grpc-ecosystem/grpc-gateway/protoc-gen-swagger

echo "Step 4.6: Add GOPATH to PATH"
...
echo "Step 5.1: Compile proto file at api/*.proto ..."
...
echo "Step 5.2: Compile reverse proxy file at api/*.proto ..."
protoc -I/usr/local/include -I. \
  -I$GOPATH/src \
  -I$GOPATH/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis \
...
echo "Step 5.3: Compile swagger file at api/*.proto ..."
...
echo "Step 5.4: Compile swagger to go file at third-party/swagger-ui/* ..."
...
# 6: Build main file
echo "Step 6.1: Build main file at internal/main.go ..."
go build -o HelloTencent internal/main.go

echo "Step 6.2: Build common service client file at examples/common_service_client.go ..."
go build -o CommonClient examples/common_service_client.go

echo "Step 6.3: Build common service client file at examples/common_service_web.go ..."
